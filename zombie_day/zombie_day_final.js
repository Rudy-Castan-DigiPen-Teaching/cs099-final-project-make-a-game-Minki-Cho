...
function zombie_final_setup()
{
    ...
    // }
    // for ( let count3 = 0; count3 < 100; count3++ )
    // {
...
function zombie_final_draw()
{
    ...
    // if ( zombies_final_wave1.length <= 80 )
    // {
    //     zombie_day_update( zombies_final_wave2 );
    // }
    // //if stage2's zombies and stage1's zombies left 4 then next stage is starting
    // if ( zombies_final_wave1.length + zombies_final_wave2.length <= 80 )
    // {
    //     zombie_day_update( zombies_final_wave3 );
    // }
    // if ( zombies_final_wave1.length + zombies_final_wave2.length + zombies_final_wave3.length <= 80 )
    // {
    //     zombie_day_update( zombies_final_wave4 );
    // }
    // if ( zombies_final_wave1.length + zombies_final_wave2.length + zombies_final_wave3.length + zombies_final_wave4 <= 80 )
    // {
